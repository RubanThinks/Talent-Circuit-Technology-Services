...
import { Building2, Search, Zap, Award } from "lucide-react";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import { Card, CardContent } from "@/components/ui/card";

const employerSteps = [
  { icon: Search, title: "Precision Sourcing", desc: "Leveraging our global network to find the needle in the haystack." },
  { icon: Zap, title: "Rapid Turnaround", desc: "Our recruitment speed is industry-leading, reducing your cost per hire." },
  { icon: Award, title: "Vetted Excellence", desc: "Rigorous assessment protocols ensure only top 1% talent reaches you." },
];
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h1 className="font-heading text-5xl sm:text-6xl font-black uppercase mb-8 tracking-tighter leading-none">
                BUILD <br /> TOP-TIER TEAMS
              </h1>
              <p className="text-slate-400 text-lg mb-10 max-w-lg font-medium leading-relaxed">
                Connect with world-class talent and build teams that drive your organization's mission forward.
              </p>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="font-heading text-3xl font-black text-slate-950 mb-16 uppercase text-center tracking-tighter italic">Transform Your Hiring DNA</h2>
