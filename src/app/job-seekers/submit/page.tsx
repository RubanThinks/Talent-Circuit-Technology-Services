            ...
            <main className="pt-20 bg-slate-50 min-h-screen">
                ...
                <div className="bg-slate-950 py-20 text-white">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <h1 className="font-heading text-5xl sm:text-7xl font-black uppercase tracking-tighter italic leading-none mb-4">
                            SUBMIT <br /> <span className="text-sky-600">DOCUMENTATION</span>
                        </h1>
