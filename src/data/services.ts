...
export const servicesData = {
  "permanent-staffing": {
    ...
    features: [
      ...
      "Executive-level vetting for all roles",
      "Long-term retention strategy consulting"
    ],
    benefits: [
  ...
  "executive-search": {
    ...
    features: [
      ...
      "Leadership psychology assessment",
      "Strategic alignment verification"
    ],
    benefits: [
      "Unlocking visionary leadership",
      "Highly confidential process",
      "Minimized leadership risk",
      "Market-leading talent access"
    ]
  },
  "rpo-services": {
    title: "RPO Services",
  ...
  "it-staffing": {
    ...
    features: [
      ...
      "Data science & AI talent pool",
      "Cybersecurity expert network"
    ],
    benefits: [
      "Deep technical expertise access",
      "Faster product release cycles",
      "Future-proofed tech teams",
